...
- **Published package:** This is a published Elm package (`jamesrweb/elm-combinators`).
...
A combinatory logic library for Elm — the combinators (I, K, S and friends) expressed as small, composable, fully typed functions.
